  ...
  return (
    <div id="home" className="py-8">
      <div className="text-center relative">
        ...
        <div className="bg-white/20 py-1 px-4 rounded-3xl absolute left-0 bottom-8 text-white">React</div>
        <div className="bg-white/20 py-1 px-4 rounded-3xl absolute right-16 bottom-16 text-white">Tailwind css</div>
      </div>
    </div>
  );
};
