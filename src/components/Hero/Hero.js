  ...
  return (
    <div id="home" className="py-8">
      <div className="text-center relative">
        ...
        <Link to="#" className="mt-12 inline-block bg-white py-2 px-4 font-semibold capitalize rounded-lg hover:bg-black hover:text-white transition-all duration-500">connect with me</Link>
